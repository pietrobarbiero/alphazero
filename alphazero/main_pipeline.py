...
if __name__ == "__main__":
    ...
    parser.add_argument("--total_iterations", type=int, default=1, help="Total number of iterations to run")
    parser.add_argument("--MCTS_num_processes", type=int, default=1,
                        help="Number of processes to run MCTS self-plays")
    parser.add_argument("--num_games_per_MCTS_process", type=int, default=5, # 120
